...
void popularListaAdjcente(GrafoA* Ga)
{
   ...
   inserirGrafoAdj(Ga,0,2);
   inserirGrafoAdj(Ga,0,5);
   inserirGrafoAdj(Ga,1,0);
   inserirGrafoAdj(Ga,1,2);
   inserirGrafoAdj(Ga,1,3);
   inserirGrafoAdj(Ga,2,0);
   inserirGrafoAdj(Ga,2,1);
   inserirGrafoAdj(Ga,2,3);
   inserirGrafoAdj(Ga,2,4);
   inserirGrafoAdj(Ga,3,1);
   inserirGrafoAdj(Ga,3,2);
   inserirGrafoAdj(Ga,3,4);
   inserirGrafoAdj(Ga,4,2);
   inserirGrafoAdj(Ga,4,3);
   inserirGrafoAdj(Ga,4,5);
   inserirGrafoAdj(Ga,5,0);
...
void popularGrafoM(GrafoM *Gm)
{
   ...
   inserirGrafoM(Gm,0,2);
   inserirGrafoM(Gm,0,5);
   inserirGrafoM(Gm,1,0);
   inserirGrafoM(Gm,1,2);
   inserirGrafoM(Gm,1,3);
   inserirGrafoM(Gm,2,0);
   inserirGrafoM(Gm,2,1);
   inserirGrafoM(Gm,2,3);
   inserirGrafoM(Gm,2,4);
   inserirGrafoM(Gm,3,1);
   inserirGrafoM(Gm,3,2);
   inserirGrafoM(Gm,3,4);
   inserirGrafoM(Gm,4,2);
   inserirGrafoM(Gm,4,3);
   inserirGrafoM(Gm,4,5);
   inserirGrafoM(Gm,5,0);
