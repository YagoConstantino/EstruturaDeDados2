...
int main () {
   ...
   */
   ...
   /*Inserção das arestas conforme a aula: */
    inserir_aresta (G, 0, 7); inserir_aresta (G, 7, 0);
    inserir_aresta (G, 0, 5); inserir_aresta (G, 5, 0);
    inserir_aresta (G, 1, 2); inserir_aresta (G, 2, 1);
    inserir_aresta (G, 1, 4); inserir_aresta (G, 4, 1);
    inserir_aresta (G, 1, 5); inserir_aresta (G, 5, 1);
    inserir_aresta (G, 2, 3); inserir_aresta (G, 3, 2);
    inserir_aresta (G, 2, 4); inserir_aresta (G, 4, 2);
    inserir_aresta (G, 3, 4); inserir_aresta (G, 4, 3);
    inserir_aresta (G, 4, 5); inserir_aresta (G, 5, 4);
    inserir_aresta (G, 6, 7); inserir_aresta (G, 7, 6);
